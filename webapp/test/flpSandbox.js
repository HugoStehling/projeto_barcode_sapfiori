		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbuscarprodutos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbuscarprodutos-display": {
								"semanticObject": "zbuscarprodutos",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbuscarprodutos",
									"url": sap.ui.require.toUrl("zbuscarprodutos")
								}
							}
						}
					}
